...
const migrations: Migration[] = [
    {
        ...
        up: async () => {
            ...
            const migrations = [
                { col: 'sync_attempts', sql: 'ALTER TABLE posts ADD COLUMN sync_attempts INTEGER DEFAULT 0' },
                { col: 'sync_status', sql: "ALTER TABLE posts ADD COLUMN sync_status TEXT DEFAULT 'pending'" },
